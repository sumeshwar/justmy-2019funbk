				...
				<div class="box-body">
					...
					<!--div class="row">	
						...
						<div class="col-sm-12">
							...
							<button  type="button" class="btn btn-info" style="float:right;" onclick="window.location.href='<?php echo base_url(); ?>user/User/addUser'" />Add User</button>
							</div>
						</div>
					</form>
					</div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody><?php if ($user) { ?>
					<?php $i=1; foreach ($user as $userDetails): ?>
                      <tr>
					  ...
					  <td><?php echo ucfirst($userDetails->username); ?></td>
  						<td>
						    ...
						    <a href="<?php echo base_url()."user/User/editUser?UserId=".$userDetails->user_id ?>">
						     <span class="fa fa-pencil-square-o" id="res"></span>
						    </a> | 
							<a href="<?php echo base_url()."user/User/deleteUser?UserId=".$userDetails->user_id ?>">
