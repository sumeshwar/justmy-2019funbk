...
$("#chartContainer5").CanvasJSChart(options4);
					 		...
					 		<div class="manage-jobs-sec">
						 		...
						 		<div class="cat-sec">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="chartContainer" style="height: 100%; width: 100%;"></div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="chartContainer1" style="height: 300px; width: 100%;"></div>
										
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"style="    margin-top: 310px;">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="chartContainer5" style="height: 300px; width: 100%;"></div>
									</div>
										<!--div class="col-lg-6 col-md-6 col-xs-12">
											<div class="candidate-category">
												<a href="#" title="">
													...
													<span>Respective reports based on above functions</span>
													<!--p>14 Applications</p>
												</a>
											</div>
										</div-->
