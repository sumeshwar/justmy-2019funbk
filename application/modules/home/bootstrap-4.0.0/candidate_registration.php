...
<div class="theme-layout" id="scrollup">
			...
			<div class="container">
				...
				<div class="stepwizard col-md-offset-3">
    				<div class="stepwizard-row setup-panel">
						...
						<a href="#step-1" type="" class="btn btn-primary btn-circle">1</a>
						<p>Step 1</p>
					  </div>
      				<div class="stepwizard-step">
				  ...
				  <div class="stepwizard-step">
				   ...
				   <div class="stepwizard-step">
					<a href="#step-4" type="" class="btn btn-default btn-circle" disabled="disabled">4</a>
					<p>Step 3</p>
				  </div>
					</div>
				  </div>
    ...
    <div class="row setup-content" id="step-1">
		...
		<form role="form" action="" method="post">
				<input type="radio" name="gender" value="Fresher" id="fresher" class="nextBtn" required> <span style="color:#FFFFFF;">Fresher</span></br>
  				<input type="radio" name="gender" value="Professional" id="professional" class="nextBtn"  required> <span style="color:#FFFFFF;">Professional</span>
				</form>
				</div>
				 <div class="col-md-12">
          		<button class="btn btn-danger nextBtn btn-lg pull-right" style="opacity:0" type="button">Next</button>
        </div>
    </div>
	 ...
	 <div class="row setup-content" id="step-4">
		...
		<form action="" method="post">
			...
			<div class="dropdown-field">
				...
				<div class="col-md-6">
			<input type="password" placeholder="Enter Current Company">
			<i class="fa fa-university" aria-hidden="true"></i>
				</div>
				</div>
				<div class="row">
			...
			<div class="dropdown-field">
				...
				<div class="row">
				<div class="col-md-6">
				<input type="password" placeholder="Enter Skills">
