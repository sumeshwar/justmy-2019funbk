                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php $i=1; foreach ($category as $userDetails): ?>
                      <tr>
						...
						?>
						<a href="#" onclick="activeEnactive(<?php echo $userDetails['id'].', '.$status; ?>)">
						...
						: '<span class="label label-danger" style="font-size:12px;">Inactive</span>'; ?>
  						...
  						<td>
						    <a href="<?php echo base_url()."categories/Categoriesmanage/editCategory?categoryId=".$userDetails['id']; ?>">
