              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <form role="form" action="<?php echo base_url()."market/Market/addMarketinfo"?>" onsubmit="return ContentValidation();" enctype="multipart/form-data" method="post">
						<div class="form-group">
							 <label for="exampleInputEmail1">Market Name</label> <span style="color:red;" id="BlogCategory1"></span>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<div class="form-group">
						  <label>Site Url</label>
							<input type="text" name="market_site" class="form-control" pattern="https?://.+">
						</div>
					</div>
				</div>
						<div class="form-group">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						...
						<div class="form-group">
						  <label for="inputProductPhoto">Logo</label><span id="ProductPhoto" style="color:red;"></span>
						  <input type="file" name="market_logo" id="inputProductPhoto" accept="image/x-png,image/gif,image/jpeg,image/jpg">
						</div>
						<div class="form-group">
						  <label for="inputProductPhoto">Facebook Image</label><span id="ProductPhoto" style="color:red;"></span>
						  <input type="file" name="market_facebook_image" id="inputProductPhoto" accept="image/x-png,image/gif,image/jpeg,image/jpg">
						</div>
						<div class="form-group">
						  <label for="inputProductPhoto">Header Image</label><span id="ProductPhoto" style="color:red;"></span>
						  <input type="file" name="market_header_image" id="inputProductPhoto" accept="image/x-png,image/gif,image/jpeg,image/jpg">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<div class="form-group">
