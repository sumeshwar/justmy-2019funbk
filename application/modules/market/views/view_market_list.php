          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class="box-body">
                <center><h4><span style="color:red;"><?php if($this->session->flashdata('alert')){ ?>
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="dataTables_length" id="example1_length">
								<button  type="button" class="btn btn-info" style="float:right;" onclick="window.location.href='<?php echo base_url(); ?>market/Market/addmarket'" />Add Market</button>
							</div>
						</div>
					</form>
					</div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
					  <?php if($markets){?>
					  <?php $i = 0; foreach($markets as $productList):$i++;?>
					    <td style="width:30px;"><?php echo $i;?></td>
						<td><?php echo ucfirst($productList['market_name']);?></td>
					    <td><?php echo ucfirst($productList['market_site']);?></td>
