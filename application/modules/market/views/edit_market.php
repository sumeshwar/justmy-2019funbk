              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <form role="form" action="<?php echo base_url(); ?>market/Market/updateMarketinfo?Id=<?php echo $markets[0]['market_id'];?>" onsubmit="return ContentValidation();" enctype="multipart/form-data" method="post" />
					<input type="hidden" name="market_id" value="<?php echo $markets[0]['market_id']; ?>" >
					<div class="form-group">
                      <label>Market Name</label> 
						<input type="text" name="market_name" value="<?php echo $markets[0]['market_name']; ?>" class="form-control">
				   </div>
				   <div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<div class="form-group">
                      <label>Site Title</label>
						<input type="text" name="market_site_title" value="<?php echo $markets[0]['market_site_title'];?>" class="form-control">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<div class="form-group">
                      <label>Site Url</label>
						<input type="text" name="market_site" value="<?php echo $markets[0]['market_site'];?>" class="form-control" pattern="https?://.+">
					</div>
				</div>
			</div>
					<div class="form-group">
                      <label>Site Description</label>
						<textarea id="" name="market_description" class="form-control"><?php echo $markets[0]['market_description'];?></textarea>
					</div>
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<div class="form-group">
						  <label>Facebook</label>
							<input type="text" name="market_facebook" class="form-control" value="<?php echo $markets[0]['market_facebook'];?>">
						</div>
					<div class="form-group">
                      <label>Twitter</label>
						<input type="text" name="market_twitter" value="<?php echo $markets[0]['market_twitter'];?>" class="form-control">
					</div>
					<div class="form-group">
                      <label>Youtube</label>
						<input type="text" name="market_youtube" value="<?php echo $markets[0]['market_youtube'];?>" class="form-control"></textarea>
					</div>
					<div class="form-group">
                      <label for="inputlogoimage">Logo</label>
                     
					 <?php if($markets[0]['market_logo']) { ?>
					  <a href="<?php echo base_url().'upload/images/'.$markets[0]['market_logo']; ?>" id="link" target="_blank">
							<span class="label label-success" style="font-size:11px;">View</span>
					  </a>
					  <?php } else { echo '<input type="file" name="market_logo" id="inputlogoimage">'; } ?>
					  <?php if($markets[0]['market_logo']) { ?>
					  <a href="#" id="productLinklogo" style="visibility:visible;" onclick="deletelogoimage()">
							<span class="label label-danger" style="font-size:11px;">Update</span>
					           ...
					           <input type="file" name="market_logo" id="inputlogoimage" style="display:none" accept="image/x-png,image/gif,image/jpeg,image/jpg">  
					...
					<div class="form-group">
					 ...
					 <?php if($markets[0]['market_facebook_image']) { ?>
					  <a href="<?php echo base_url().'upload/images/'.$markets[0]['market_facebook_image']; ?>" id="link" target="_blank">
							<span class="label label-success" style="font-size:11px;">View</span>
					  </a>
					  <?php } else { echo '<input type="file" name="market_facebook_image" id="inputfacebookimage">'; } ?>
					  <?php if($markets[0]['market_facebook_image']) { ?>
					  <a href="#" id="productLinkfb" style="visibility:visible;" onclick="deletefacebookimage()">
							<span class="label label-danger" style="font-size:11px;">Update</span>
							
					  </a>
					           <input type="file" name="market_facebook_image" id="inputfacebookimage" style="display:none" accept="image/x-png,image/gif,image/jpeg,image/jpg">  
					...
					<div class="form-group">
					 ...
					 <?php if($markets[0]['market_header_image']) { ?>
					  <a href="<?php echo base_url().'upload/images/'.$markets[0]['market_header_image']; ?>" id="link" target="_blank">
							<span class="label label-success" style="font-size:11px;">View</span>
					  </a>
					  <?php } else { echo '<input type="file" name="market_header_image" id="inputheaderimage">'; } ?>
					  <?php if($markets[0]['market_header_image']) { ?>
					  <a href="#" id="productLinkheader" style="visibility:visible;" onclick="deleteheaderimage()">
							<span class="label label-danger" style="font-size:11px;">Update</span>
							
					  </a>
					           <input type="file" name="market_header_image" id="inputheaderimage" style="display:none" accept="image/x-png,image/gif,image/jpeg,image/jpg">  
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<div class="form-group">
                      <label>Instagram</label>
						<input type="text" name="market_instagram" value="<?php echo $markets[0]['market_instagram'];?>" class="form-control">
					</div>
					<div class="form-group">
                      <label>Snapchat</label>
						<input type="text" name="market_snapchat" value="<?php echo $markets[0]['market_snapchat'];?>" class="form-control">
					</div>
