              ...
              <div class="box">
				...
				<form action="<?php echo base_url()."channel"?>" name="" method="POST">
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="dataTables_length" id="example1_length">
							    ...
							    <button  type="button" class="btn btn-info" style="float:right;" onclick="window.location.href='<?php echo base_url(); ?>channel/addChannel'" />Add Channel</button>
							</div>
						</div>
					</form>
					</div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php $i=1; foreach($channel as $channel): ?>
                      ...
                      <tr>
						...
						<td>
							...
							<span>|</span> <a href="<?php echo base_url(); ?>channel/deleteChannel?id=<?php echo $channel['channel_id'] ?>" class="delete">
