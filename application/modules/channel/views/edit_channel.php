		...
		<div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">				  
					...
					<?php $i=1; foreach ($channel as $channel):$i++;?>
					<form id="" role="form" action="<?php echo base_url(); ?>channel/updateChannel?Id=<?php echo $channel['channel_id'];?>" enctype="multipart/form-data" method="post"  class="attireCodeToggleBlock"/>
					...
					?>	
                      <option value="<?php echo $categoryList['id'] ?>" <?php echo $isSelected; ?>><?php echo ucfirst($categoryList['cc_title']); ?></option>
						...
						<div class="form-group">
						  ...
						  <input type="text" name="channel_name" class="form-control" id="categoryKeywords" value="<?php echo $channel['channel_name']; ?>" >
						</div>
						<div class="form-group">
						  <label for="categoryKeywords">Keywords</label>
						  <input type="text" name="channel_keywords" class="form-control" id="categoryKeywords" value="<?php echo $channel['channel_keywords']; ?>" >
						</div>
						<div class="form-group">					
						  <label for="categoriesName">Description</label>
						  <textarea id="" name="channel_description" class="form-control"><?php echo $channel['channel_description']; ?></textarea>
						</div>	
						<div class="form-group">					
						  <label for="categoryTitle">Title</label>
						  <input type="text" name="channel_title" class="form-control" id="categoryTitle" value="<?php echo $channel['channel_title']; ?>" >
						</div>
						<div class="form-group">
							 ...
							 <?php if($channel['channel_facebook_image']) { ?>
							  ...
							  <?php } else { echo '<input type="file" name="channel_facebook_image" id="inputfacebookimage">'; } ?>
							  <?php if($channel['channel_facebook_image']) { ?>
							  ...
							  <input type="file" name="channel_facebook_image" id="inputfacebookimage" style="display:none" accept="image/x-png,image/gif,image/jpeg,image/jpg"> 
								<?php } ?>
						</div>		
