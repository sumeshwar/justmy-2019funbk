...
.tooltip5 .tooltiptext{
   ...
   <div class="content-wrapper">  
          ...
          <div class="row">
			...
			<?php if($this->session->flashdata('alert')){ ?>
					...
					<?php } ?>
						...
						<div class="col-md-12">
						<div class="col-md-12">
							<a href="<?php echo base_url(); ?>companymanagement/addCompany" class="btn btn-info pull-right">Add Company</a>
							</div>
						<hr>
						<h3>Company List</h3>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="min-width: 20px;">Company Name</th>
                        <th style="min-width: 20px;">Company Address</th>				
                    ...
                    <tbody>
                      ...
                      <tr>
					  <?php if($allcompany){?>
					  <?php $i=1; foreach($allcompany as $list):?> 
					    <td><?php echo $i;?></td>
					    <td><?php echo ucfirst($list->company_name);?></td>
					    <td><?php echo ucfirst($list->company_address);?></td>
					   
						<td>
						<?php 
							if($list->satatus) $status=1; 
							
							else $status=0;
						?>
						<a href="#" onclick="activeEnactive(<?php echo $list->company_id.', '.$status ?>)">
						<?php echo ($list->satatus==1) ? '<span class="label label-success" style="font-size:12px;">Active</span>' 
						: '<span class="label label-danger" style="font-size:12px;">Inactive</span>'; ?>
						</a>
						</td>
                        <td>
							
							<a href="<?php echo base_url(); ?>companymanagement/editCompany?id=<?php echo $list->company_id; ?>" style="font-size:18px;">
		...
		function activeEnactive(id, value) {
            ...
            if (r == true) {
               window.location.assign("<?php echo base_url(); ?>companymanagement/ActiveStatus?inactiveStatusId="+id+"&statusValue="+value); 
	        }
