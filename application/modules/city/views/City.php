            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
				  ...
				  <a href="<?php echo base_url();?>city/addDeliverydata" class="pull-right">  <button class="btn bg-maroon btn-flat margin">Add City </button></a>
				  <!--a href="<?php echo base_url(); ?>city/deliveryManagement" class="pull-right">  <button class="btn bg-maroon btn-flat margin">View Delivery Management</button></a-->
                </div><!-- /.box-header -->
                    ...
                    <tbody>
					  ...
					  <?php $i=1; foreach($cityName as $cityNameList):?>
                        ...
                        <td>
							...
							<a href="<?php echo base_url(); ?>city/getCityLocality?id=<?php echo $cityNameList->cityId;?>">
							  <span class="fa fa-map-marker" id="viewDet"></span>
						    </a>
							
							<a href="<?php echo base_url(); ?>city/editCityDeliveryPrice?id=<?php echo $cityNameList->cityId;?>">
							  <span class="fa fa-edit" style="margin-left:10px;" id="viewDet"></span>
						    </a>		
						</td>
                      </tr>
